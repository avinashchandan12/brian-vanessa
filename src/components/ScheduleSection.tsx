const scheduleEvents = [
  { time: '5:30 PM', event: 'Ceremony Begins', description: 'Guests arrive and take their seats under the open sky' },
  { time: '6:45 PM', event: 'Cocktail Hour', description: 'Refreshments and mingling in the garden courtyard' },
  { time: '8:00 PM', event: 'Reception Dinner', description: 'A buffet inspired by international cuisine' },
  { time: '9:30 PM', event: 'Dancing & Celebration', description: 'Live music and dancing beneath the stars' },
  { time: '1:00 AM', event: 'Afterparty', description: 'Surprise' },
];
        ...
        <div className="relative">
          ...
          <div className="space-y-10">
            {scheduleEvents.map((item, idx) => (
              <div key={idx} className="fade-section flex gap-6 md:gap-8 items-start">
                ...
                <div className="relative flex-shrink-0">
                  <div className="w-3 h-3 rounded-full bg-sage border-2 border-cream mt-1" />
                </div>
                <div className="pb-2">
